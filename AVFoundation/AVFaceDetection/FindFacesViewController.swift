...
class FindFacesViewController: UIViewController {
    ...
    //MARK: Capture device - find front camera on video devices list
    ...
    //MARK: Preview layer - layer for displaying live preview
    lazy var previewLayer: AVCaptureVideoPreviewLayer? = {
        var preview = AVCaptureVideoPreviewLayer(session: self.session!)
        preview?.videoGravity = AVLayerVideoGravityResizeAspectFill
        
        return preview
    }()
    
    //MARK: Face detector - low accuracy for live face detection
...
//MARK: Prepare photo capture session
extension FindFacesViewController {
    func sessionPrepare() {
...
extension FindFacesViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
